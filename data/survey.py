...
#     'user': 'a204',
#     'password': 'zipjoong204^^',
#     'host': 'j10a204.p.ssafy.io',
#     'port': 3300,
#     'database': 'a204_db',
# }
...
#     # SQL 쿼리 실행 - 'LIMIT 1'을 추가하여 첫 번째 행만 가져옴
#     query = "SELECT * FROM survey LIMIT 1"  # 'survey' 테이블에서 첫 행만 선택
#     cursor.execute(query)
    
#     # 결과 가져오기
#     row = cursor.fetchone()  # 첫 행만 가져옴
